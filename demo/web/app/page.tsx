        ...
        <div className="mt-20 bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-white mb-2">Purchase Package</h4>
              <p className="text-white/80 text-sm">
                Buy access to all services in the pool with a single payment
                    </p>
                  </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-white mb-2">Access Services</h4>
              <p className="text-white/80 text-sm">
                Use all services included in your package
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-white mb-2">Auto Settlement</h4>
              <p className="text-white/80 text-sm">
                Revenue splits automatically to providers based on their shares
              </p>
            </div>
                  </div>
                </div>
